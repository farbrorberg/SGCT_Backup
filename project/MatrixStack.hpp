#ifndef __Domescape__MatrixStack__
#define __Domescape__MatrixStack__
...
public:
    ...
    // Set a Matrix as the Current mastrix
    void setCurrentMatrix(float Ny[]);
...
#endif /* defined(__Domescape__MatrixStack__) */
