...
// Set a matrix as the Current matrix
void MatrixStack::setCurrentMatrix(float Ny[]) {
    currentMatrix->previous = NULL;
    currentMatrix->m[0]= Ny[0];
    currentMatrix->m[1]= Ny[1];
    currentMatrix->m[2]= Ny[2];
    currentMatrix->m[3]= Ny[3];
    currentMatrix->m[4]= Ny[4];
    currentMatrix->m[5]= Ny[5];
    currentMatrix->m[6]= Ny[6];
    currentMatrix->m[7]= Ny[7];
    currentMatrix->m[8]= Ny[8];
    currentMatrix->m[9]= Ny[9];
    currentMatrix->m[10]=Ny[10];
    currentMatrix->m[11]=Ny[11];
    currentMatrix->m[12]=Ny[12];
    currentMatrix->m[13]=Ny[13];
    currentMatrix->m[14]=Ny[14];
    currentMatrix->m[15]=Ny[15];
};
